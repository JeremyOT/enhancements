...
endpoint of the headless service. Pods backing a supercluster service may be
addressed individually using the
`<hostname>.<clustername>.<svc>.<ns>.svc.supercluster.local` format.
